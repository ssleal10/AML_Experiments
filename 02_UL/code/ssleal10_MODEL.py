...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.l2norm(out)
        return out
#### TODO In a new file named "USER_Model" (e.g. mfroa_Model), implement a
# very simple architecture, e.g., composed of a convolutional layer,
# batch normalization, ReLu and a linear layer.
